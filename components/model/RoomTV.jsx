...
Files: /home/TA/resource/Laboratory/RoomTV.glb [2.57MB] > RoomTV-transformed.glb [393.26KB] (85%)
*/
...
export function RoomTV(props) {
  ...
  const texture = useVideoTexture(`../../public/videos/video_1`, {loop: true})
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-0.214, 0.465, 2.185]} rotation={[-Math.PI, 0, -Math.PI]} scale={0.6}>
        <mesh castShadow receiveShadow geometry={nodes.TV_1.geometry}>
